...
function theme_scripts() {
	wp_enqueue_script( 'theme_js', plugin_dir_url( __FILE__ ) . 'assets/js/theme_scripts.js', '', '1.0.0', true );
}
...
function theme_styles() {
    wp_enqueue_style( 'theme_css', plugin_dir_url( __FILE__ ) . 'assets/css/theme_styles.css', array(), null );
}
